...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className={cn("min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4")}>
          <div className={cn("max-w-md w-full bg-white dark:bg-slate-900 shadow-2xl rounded-3xl p-8 text-center border border-slate-200 dark:border-slate-800")}>
            <div className={cn("w-20 h-20 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-6")}>
            ...
            <button
              ...
              className={cn("w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg active:scale-95")}
            >
              Recargar Aplicación
            </button>
          </div>
