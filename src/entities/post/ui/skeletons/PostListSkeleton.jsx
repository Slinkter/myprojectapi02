...
const PostListSkeleton = memo(() => {
  return (
    <div className={cn("max-w-4xl mx-auto my-12 px-4")}>
      ...
      <div className={cn("grid gap-6")}>
        {[1, 2, 3].map((i) => (
          <div key={`post-skeleton-${i}`} className={cn("relative overflow-hidden bg-white/30 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-700 p-6 rounded-xl shadow-sm")}>
            <Shimmer />
