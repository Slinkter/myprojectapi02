...
const NotFoundCard = memo(({ attemptedId }) => {
  return (
    <div className={cn(
      "bg-white dark:bg-slate-900 shadow-sm rounded-3xl p-10 text-center border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-300 ease-out"
    )}
    role="status"
    aria-live="polite"
    >
